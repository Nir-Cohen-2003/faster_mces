...
std::vector<float> py_calculate_symmetric_distance_matrix(const std::vector<std::string>& smiles_list) {
    return calculate_symmetric_distance_matrix(smiles_list);
}

std::vector<float> py_calculate_distance_matrix(const std::vector<std::string>& smiles_list1, const std::vector<std::string>& smiles_list2) {
